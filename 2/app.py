...
def page_setup() -> None:
    ...
    st.markdown(
        ...
        <style>
        .stApp {
            background: linear-gradient(180deg, #f7fbff 0%, #fbfaf6 54%, #ffffff 100%);
        }
        ...
        .hero {
            ...
            border-radius: 22px;
            background:
              radial-gradient(circle at 12% 20%, rgba(59,130,246,.16), transparent 30%),
              radial-gradient(circle at 88% 0%, rgba(16,185,129,.16), transparent 26%),
